...
\def\headertitle{Evaluating the benefit of initiating RSV prophylaxis based on state- and county-level data}
...
\newcommand\frontmatter{
    ...
    \frontmattersection{Short title}{Optimization of RSV prophylaxis in Connecticut}
    \frontmattersection{Conflict of interest disclosures}{The authors have no conflicts of interest to disclose.}
    \frontmattersection{Funding}{}
    \frontmattersection{Role of funder}{The NIH had no role in the design and conduct of the study. CT DPH had no role in the design and conduct of the study.}
    \frontmattersection{Clinical trial registration}{Not applicable.}
