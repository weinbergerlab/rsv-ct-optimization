...
\author{
    ...
    \authorstyle{Daniel Weinberger, PhD\textsuperscript{a}}
}
...
\newcommand\frontmatter{
    ...
    \frontmattersection{Conflict of interest disclosures}{The authors have no conflicts of interest to disclose.}
    ...
    \frontmattersection{What's known on this subject}{RSV is a seasonal respiratory infection, and a major cause of mortality and morbidity in high-risk infants worldwide. RSV chemoprophylaxys is expensive. In the US, the prophylaxys schedule recommendation is published by the AAP. The AAP recommens the same schedule for all states other than Florida.}
