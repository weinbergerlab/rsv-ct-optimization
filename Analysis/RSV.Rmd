...
install.packages(c("dplyr", "zipcode", "reshape", "mgcv", "ggplot2", "gridExtra", "devtools", "data.table", "tikzDevice", "splitstackshape", "maps", "mapproj", "rgdal", "rgeos", "scales"))
library(devtools)
